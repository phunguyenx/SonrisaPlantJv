...
public class RemoveFromWishListUseCase {
    ...
    public RemoveFromWishListUseCase(PlantRepository plantRepository, Application application) {
        this.plantRepository = plantRepository;
        this.application = application;
    }
    public void execute(UUID request, CallBackResponse callback){
        Call<ResponseUUID> call = plantRepository.removeFromWishList(request);
