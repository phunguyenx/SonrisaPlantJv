...
public class PlantHomeAdapter extends RecyclerView.Adapter<PlantHomeAdapter.PlantHomeHolder> {
    public List<PlantDto> plants;
    private final PlantHomeAdapter.ClickListener clickListener;
    public PlantHomeAdapter(List<PlantDto> plants, ClickListener clickListener){
        this.plants = plants;
